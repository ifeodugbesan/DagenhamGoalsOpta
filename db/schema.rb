...
ActiveRecord::Schema.define(version: 2020_10_26_224534) do
  ...
  create_table "match_goals", force: :cascade do |t|
    ...
    t.bigint "assist_id", null: false
    t.bigint "match_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["assist_id"], name: "index_match_goals_on_assist_id"
    t.index ["goal_id"], name: "index_match_goals_on_goal_id"
